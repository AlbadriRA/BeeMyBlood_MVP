defmodule MatchingWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MatchingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MatchingWeb.Gettext, "errors", msg, opts)
    end
  end
